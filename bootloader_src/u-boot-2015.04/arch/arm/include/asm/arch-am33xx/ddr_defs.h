...
// [FALINUX]
/* Nanya NT5CC512M8DN-DII 2x512MB=1GiB (800MHz, DDR3L-1600) */
#if 1
#define NT5CC512M8DN_DII_EMIF_READ_LATENCY	0x100007
#define NT5CC512M8DN_DII_EMIF_TIM1			0x0AAAD4DB
#define NT5CC512M8DN_DII_EMIF_TIM2			0x266B7FDA
#define NT5CC512M8DN_DII_EMIF_TIM3			0x501F867F
#define NT5CC512M8DN_DII_EMIF_SDCFG			0x61C053B2	// termination = 1 (RZQ/4)
														// dynamic ODT = 2 (RZQ/2)
														// SDARM drive = 0 (RZQ/6)
														...
														// dynamic ODT = 2 (RZQ/2)
#define NT5CC512M8DN_DII_EMIF_SDREF			0x00000C30	// 400 * 7.8us = 0xC30
#define NT5CC512M8DN_DII_ZQ_CFG				0x50074BE4
#define NT5CC512M8DN_DII_RATIO				0x80
#define NT5CC512M8DN_DII_INVERT_CLKOUT		0x0
#define NT5CC512M8DN_DII_RD_DQS				0x32		// 
#define NT5CC512M8DN_DII_WR_DQS				0x48		// 
#define NT5CC512M8DN_DII_PHY_FIFO_WE		0x99		// 
#define NT5CC512M8DN_DII_PHY_WR_DATA		0x80		// 
#define NT5CC512M8DN_DII_IOCTRL_VALUE		0x18B
#else
#define NT5CC512M8DN_DII_EMIF_READ_LATENCY	0x100006
#define NT5CC512M8DN_DII_EMIF_TIM1			0x0888A39B
#define NT5CC512M8DN_DII_EMIF_TIM2			0x26517FDA
#define NT5CC512M8DN_DII_EMIF_TIM3			0x501F84EF
#define NT5CC512M8DN_DII_EMIF_SDCFG			0x61C04B32	// termination = 1 (RZQ/4)
														// dynamic ODT = 2 (RZQ/2)
														// SDARM drive = 0 (RZQ/6)
														// CWL         = 0 (CAS write latency = 5)
														// CL          = 4 (CAS latency = 6)
														...
														// PAGESIZE    = 2 (10 column bits))
														// dynamic ODT = 2 (RZQ/2)
#define NT5CC512M8DN_DII_EMIF_SDREF			0x0000093B	// 303 * 7.8us = 0x93B
#define NT5CC512M8DN_DII_ZQ_CFG				0x50074BE4
#define NT5CC512M8DN_DII_RATIO				0x80
#define NT5CC512M8DN_DII_INVERT_CLKOUT		0x0
#define NT5CC512M8DN_DII_RD_DQS				0x39	// 0x32
#define NT5CC512M8DN_DII_WR_DQS				0x38	// 0x48
#define NT5CC512M8DN_DII_PHY_FIFO_WE		0x98	// 0x99
#define NT5CC512M8DN_DII_PHY_WR_DATA		0x76	// 0x80
#define NT5CC512M8DN_DII_IOCTRL_VALUE		0x18B
#endif
...
/**
 * Configure DDR PHY
 *		TRM(Technical Reference Manual) 7.3.6 Page.888
*/
