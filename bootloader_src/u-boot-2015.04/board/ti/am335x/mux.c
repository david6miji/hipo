...
static struct module_pin_mux uart5_pin_mux[] = {
	...
	{OFFSET(mii1_rxdv), (MODE(3) | PULLUDEN)},				/* UART5_TXD */
	{-1},
};
...
// [FALINUX]
static struct module_pin_mux mmc0_no_wp_pin_mux[] = {
	{OFFSET(mmc0_dat3), (MODE(0) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT3 */
	{OFFSET(mmc0_dat2), (MODE(0) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT2 */
	{OFFSET(mmc0_dat1), (MODE(0) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT1 */
	{OFFSET(mmc0_dat0), (MODE(0) | RXACTIVE | PULLUP_EN)},	/* MMC0_DAT0 */
...
// [FALINUX] MMC0 : V1.0 eMMC, V2.0 uSD
#ifdef CONFIG_LG_SOLAR_GW_MUX
static struct module_pin_mux mmc0_no_cd_wp_pin_mux[] = { 
	{OFFSET(mmc0_dat3), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT3 */
	{OFFSET(mmc0_dat2), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT2 */
	{OFFSET(mmc0_dat1), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT1 */
	{OFFSET(mmc0_dat0), (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_DAT0 */
	{OFFSET(mmc0_clk),  (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_CLK */
	{OFFSET(mmc0_cmd),  (MODE(0) | RXACTIVE | PULLUP_EN)},  /* MMC0_CMD */
	{OFFSET(gpmc_csn0), (MODE(7) | RXACTIVE | PULLUP_EN)},	/* MMC0_WP */
	{OFFSET(mcasp0_aclkx), (MODE(7) | RXACTIVE | PULLUP_EN)},	/* MMC0_CD */
	{-1},
};
#endif
...
static struct module_pin_mux mmc1_pin_mux[] = {
	...
	{OFFSET(mcasp0_aclkx), (MODE(7) | RXACTIVE | PULLUP_EN)},	/* MMC1_CD */
	{-1},
};

// [FALINUX] MMC1 : V1.0 uSD, V2.0 eMMC
#ifdef CONFIG_LG_SOLAR_GW_MUX
static struct module_pin_mux mmc1_no_wd_pin_mux[] = {
	{OFFSET(gpmc_ad3), (MODE(1) | RXACTIVE | PULLUP_EN)},   /* MMC1_DAT3 */
	{OFFSET(gpmc_ad2), (MODE(1) | RXACTIVE | PULLUP_EN)},   /* MMC1_DAT2 */
	{OFFSET(gpmc_ad1), (MODE(1) | RXACTIVE | PULLUP_EN)},   /* MMC1_DAT1 */
	{OFFSET(gpmc_ad0), (MODE(1) | RXACTIVE | PULLUP_EN)},   /* MMC1_DAT0 */
	{OFFSET(gpmc_csn1), (MODE(2) | RXACTIVE | PULLUP_EN)},  /* MMC1_CLK */
	{OFFSET(gpmc_csn2), (MODE(2) | RXACTIVE | PULLUP_EN)},  /* MMC1_CMD */
	{OFFSET(gpmc_wait0), (MODE(4) | RXACTIVE | PULLUP_EN)}, /* MMC1_CD */
	{-1},
};
#endif
...
// [FALINUX] RMII RESET GPIO
#ifdef CONFIG_LG_SOLAR_GW_MUX
static struct module_pin_mux gpio_lg_solar_gw_pin_mux[] = {
	{OFFSET(gpmc_be1n), (MODE(7) | PULLUP_EN)},	/* GPIO1_28 */
	{OFFSET(gpmc_a1), (MODE(7) | PULLUP_EN)},	/* GPIO1_17 */
	{-1},
};
#endif
...
{
// [FALINUX] MMC0 : V1.0 eMMC, V2.0 uSD,  MMC1 : V1.0 uSD, V2.0 eMMC
#ifdef CONFIG_LG_SOLAR_GW_MUX
	if (board_is_lg_solar_gw(header)) {
	    configure_module_pin_mux(i2c1_pin_mux);
		configure_module_pin_mux(gpio_lg_solar_gw_pin_mux);
		configure_module_pin_mux(rmii1_pin_mux);
		configure_module_pin_mux(mmc0_no_cd_wp_pin_mux);
		configure_module_pin_mux(mmc1_no_wd_pin_mux);
#else
