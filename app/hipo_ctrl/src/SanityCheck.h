 ...
 */
// @YYC #if !defined(ARDUINO) || ARDUINO < 10600
// @YYC   #error Versions of Arduino IDE prior to 1.6.0 are no longer supported, please update your toolkit.
// @YYC #endif
...
// @YYC #if !HAS_HEATER_0
// @YYC   #error HEATER_0_PIN not defined for this board.
// @YYC #elif !PIN_EXISTS(TEMP_0)
// @YYC   #error TEMP_0_PIN not defined for this board.
// @YYC #elif !PIN_EXISTS(E0_STEP) || !PIN_EXISTS(E0_DIR) || !PIN_EXISTS(E0_ENABLE)
// @YYC   #error E0_STEP_PIN, E0_DIR_PIN, or E0_ENABLE_PIN not defined for this board.
// @YYC #elif TEMP_SENSOR_0 == 0
// @YYC   #error TEMP_SENSOR_0 is required.
// @YYC #endif
