...
// @YYC #include <util/delay.h>
// @YYC #include <avr/pgmspace.h>
// @YYC #include <avr/eeprom.h>
...
// @YYC extern const char errormagic[] PROGMEM;
// @YYC extern const char echomagic[] PROGMEM;
