...
#define EP_MODE_AUTOREQ_NONE		0	// [FALINUX] 2016.06.22 : #define EP_MODE_AUTOREG_NONE		0
#define EP_MODE_AUTOREQ_ALL_NEOP	1	// [FALINUX] 2016.06.22 : #define EP_MODE_AUTOREG_ALL_NEOP	1
#define EP_MODE_AUTOREQ_ALWAYS		3	// [FALINUX] 2016.06.22 : #define EP_MODE_AUTOREG_ALWAYS	3
...
static void cppi41_trans_done(struct cppi41_dma_channel *cppi41_channel)
{
	struct musb_hw_ep *hw_ep = cppi41_channel->hw_ep;
	struct musb *musb = hw_ep->musb;
	void __iomem *epio = hw_ep->regs;	// [FALINUX] 2016.06.22
	u16 csr;							// [FALINUX] 2016.06.22
...
//		u16 csr;	// [FALINUX] 2016.06.22
		u32 remain_bytes;
//		void __iomem *epio = cppi41_channel->hw_ep->regs;	// [FALINUX] 2016.06.22
	...
	if (use_gen_rndis) {
		...
		if (len > packet_sz) {
			...
			cppi41_set_autoreq_mode(cppi41_channel,
					EP_MODE_AUTOREQ_ALL_NEOP);	// [FALINUX] 2016.06.22 : EP_MODE_AUTOREG_ALL_NEOP);
		} else {
			musb_writel(musb->ctrl_base,
			...
			cppi41_set_autoreq_mode(cppi41_channel,
					EP_MODE_AUTOREQ_NONE);	// [FALINUX] 2016.06.22 : EP_MODE_AUTOREG_NONE);
		}
	} else {
		/* fallback mode */
		cppi41_set_dma_mode(cppi41_channel, EP_MODE_DMA_TRANSPARENT);
		cppi41_set_autoreq_mode(cppi41_channel, EP_MODE_AUTOREQ_NONE);	// [FALINUX] 2016.06.22 : cppi41_set_autoreq_mode(cppi41_channel, EP_MODE_AUTOREG_NONE);
